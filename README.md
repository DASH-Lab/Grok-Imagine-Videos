...
> If the download fails after waiting, the script will retry using the first prompt.
> The generated thumbnail images (prompt photos) are also based on the text prompts.
